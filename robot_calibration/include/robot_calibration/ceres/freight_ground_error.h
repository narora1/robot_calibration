...
#ifndef ROBOT_CALIBRATION_CERES_FREIGHT_GROUND_ERROR_H
#define ROBOT_CALIBRATION_CERES_FREIGHT_GROUND_ERROR_H
...
struct FreightGroundError
{
  FreightGroundError(Camera3dModel* camera_model,
                                     ...
                                     robot_calibration_msgs::CalibrationData& data)
  {
    ...
    ceres::DynamicNumericDiffCostFunction<FreightGroundError> * func;
    func = new ceres::DynamicNumericDiffCostFunction<FreightGroundError>(
                    new FreightGroundError(camera_model, offsets, data, z));
